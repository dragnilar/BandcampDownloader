...
namespace BandcampDownloader
{
    internal static class Constants
    {
        ...
        /// </summary>
        public static readonly string LatestReleaseWebsite =
            "https://github.com/Otiel/BandcampDownloader/releases/latest";

        /// <summary>
        ///     The help text displayed in the URL list textbox.
        /// </summary>
        public static readonly string UrlsHint =
        ...
        /// </summary>
        public static readonly string UserSettingsFilePath =
            Directory.GetParent(Assembly.GetExecutingAssembly().Location) + @"\BcDlSettings.ini";
    }
}